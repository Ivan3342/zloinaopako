  ...
  return (
    ...
    <div id='menu' className='hidden z-999 bg-white/70 backdrop-blur-md h-screen w-screen p-10 flex-col justify-between items-end gap-10'>
        ...
        <div className='flex flex-col items-center justify-center mx-auto my-auto gap-5'>
          <NavLink onClick={toggleMenu} to="/" className='px-10 py-3 text-black font-bold text-xl border-black border-2 rounded-lg cursor-pointer hover:bg-[#0000000e] hover:shadow-xl hover:underline transition-all hover:scale-105 w-50 text-center'>POCETNA</NavLink>
          <NavLink onClick={toggleMenu} to="/menu" className='px-10 py-3 text-black font-bold text-xl border-black border-2 rounded-lg cursor-pointer hover:bg-[#0000000e] hover:shadow-xl hover:underline transition-all hover:scale-105 w-50 text-center'>MENI</NavLink>
          ...
          <NavLink onClick={toggleMenu} to="/gallery" className='px-10 py-3 text-black font-bold text-xl border-black border-2 rounded-lg cursor-pointer hover:bg-[#0000000e] hover:shadow-xl hover:underline transition-all hover:scale-105 w-50 text-center'>GALERIJA</NavLink>
        </div>
      </div>
